...
$ubicacion = $_POST['ubicacionGraduado'];
...
fecha_graduacion, carrera_graduacion, ubicacion, rol) VALUES (NULL, '$nombre', '$apellido', '$fecha_nacimiento', '$identificacion', '$codigo', '$correo', 
'$contrasena', '$fecha_graduacion', '$carrera', '$ubicacion', '2')");
